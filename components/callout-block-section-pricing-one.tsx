...
export const CalloutBlockSectionPricingOne = () => {
      ...
      >
        ...
        >
          <div className="max-w-4xl mx-auto">
            ...
            >
              Critter offers pet professionals joining the platform for the
              first time a white glove onboarding experience. After downloading
              the app and testing the platform out with our free trial, reach
              out to our team. We&apos;ll work with you to understand your needs,
              import existing customer data, conduct hands-on training, and kick
              off your Critter experience with ease.
            </p>
