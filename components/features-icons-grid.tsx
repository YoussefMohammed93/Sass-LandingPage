...
export const FeaturesIconsGridSection = () => {
  ...
  return (
    ...
    >
      <h2
        ref={headingRef}
        className="max-w-3xl mx-auto text-center text-3xl sm:text-4xl lg:text-5xl font-ovo will-change-transform"
      >
        Play your part with technology that works for you, no matter your role
      </h2>
      <div
        ref={gridRef}
      ...
      >
        ...
        >
          ...
          <p className="text-sm font-light text-muted-foreground text-center">
            Keep clients in the loop with start and end notifications, photo and
            video options, and built-in service reports. Stay on top of your
            business while you’re on the go, animals by your side.
          </p>
        </div>
        <div
          ref={(el) => {
        ...
        >
          ...
          <p className="text-sm font-light text-muted-foreground text-center">
            Make overnights easy with Critter&apos;s Care Plan, which prompts
            clients to share required care activities and instructions in-app so
            the details you need are always a tap away.
          </p>
        </div>
        <div
          ref={(el) => {
        ...
        >
          ...
          <p className="text-sm font-light text-muted-foreground text-center">
            Welcome pets into your home and calm client nerves using
            Critter&apos;s activity tracking features. Build trust through easy,
            consistent updates, designed for fun and easy client updates.
          </p>
        </div>
        <div
          ref={(el) => {
        ...
        >
          ...
          <p className="text-sm font-light text-muted-foreground text-center">
            Build a plan and have clients track progress against it within the
            app. Know what&apos;s working and what&apos;s not as it happens so
            you can share resources and deliver the best results.
          </p>
        </div>
        <div
          ref={(el) => {
        ...
        >
          ...
          <p className="text-sm font-light text-muted-foreground text-center">
            Build customer relationships with easy tools for scheduling,
            instructions, before and after photos, and updating clients on
            progress right from the groomer&apos;s table.
          </p>
        </div>
      </div>
    </section>
