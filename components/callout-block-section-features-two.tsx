...
export const CalloutBlockSectionFeaturesTwo = () => {
  const sectionRef = useRef<HTMLElement>(null);
  const containerRef = useRef<HTMLDivElement>(null);
  const heartsImageRef = useRef<HTMLImageElement>(null);
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      if (prefersReducedMotion) {
        ...
        gsap.set(heartsImageRef.current, {
          opacity: 0,
          scale: 0.6,
          y: -30,
          rotation: mobile ? 0 : -15,
          transformOrigin: "center center",
        });
        ...
        if (!mobile) {
          ScrollTrigger.create({
            ...
            onUpdate: (self) => {
              ...
              gsap.to(heartsImageRef.current, {
                y: progress * -20,
                rotation: progress * 5,
                duration: 0.3,
                ease: "sine.out",
      ...
      >
        ...
        >
          <div className="max-w-4xl mx-auto">
            ...
            >
              Our team will be there when you need us. With direct access via a
              dedicated support phone number and email address, in addition to a
              library of virtual training content, you&apos;ll have the
              resources you need to always feel comfortable and supported as you
              build your business. Whether you have a question on how to do
              something, an issue with the technology, or a request for a new
              feature, we&apos;re available and will respond promptly.
            </p>
