...
export const TechSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        Build your business with <br className="hidden sm:block" /> technology
        that works for you
      </h2>
      <div
        ref={gridRef}
      ...
      >
        ...
        >
          ...
          <p className="text-base sm:text-lg font-light text-muted-foreground">
            A best in class technology experience with tools for onboarding,
        ...
        >
          ...
          <p className="text-base sm:text-lg font-light text-muted-foreground">
            Focus your time where it matters most by streamlining daily
            operations and automating administrative tasks.
          </p>
        </div>
        <div
          ref={(el) => {
        ...
        >
          ...
          <p className="text-base sm:text-lg font-light text-muted-foreground">
            Software built for hands on, on the go businesses. Everything you
            need, always in your pocket.
          </p>
        </div>
        <div
          ref={(el) => {
        ...
        >
          ...
          <p className="text-base sm:text-lg font-light text-muted-foreground">
            Collect records, share policies, and document care history to
            protect your business and enforce accountability.
          </p>
        </div>
      </div>
    </section>
