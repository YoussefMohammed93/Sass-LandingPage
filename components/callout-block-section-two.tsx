...
export const CalloutBlockSectionTwo = () => {
      ...
      >
        ...
        >
          <div className="max-w-4xl mx-auto">
            ...
            >
              Real value delivered every day
            </h1>
            <p
              ref={paragraphRef}
            ...
            >
              Simplify the way you work without spending a paw and a tail.
              Technology to get organized and grow the business as the demands
              on your time grow with it, designed with you in mind.
            </p>
